// src/components/tables/PipelineFilter.tsx
...
export const PipelineFilter: React.FC<PipelineFilterProps> = ({ 
  onFilter,
  placeholder = "Search pipelines... (e.g., status=success or name:frontend)"
}) => {
          ...
          <div className="space-y-2 text-blue-800">
            <div>
              ...
              <div className="ml-4 mt-1 space-y-1">
                <div><code className="bg-blue-100 px-2 py-0.5 rounded">status=success</code> - Status is exactly "success"</div>
                <div><code className="bg-blue-100 px-2 py-0.5 rounded">branch=main</code> - Branch is exactly "main"</div>
              </div>
            </div>
            ...
            <div className="mt-3">
              ...
              <div className="ml-4 mt-1 space-y-1">
                <div><code className="bg-blue-100 px-2 py-0.5 rounded">name:frontend</code> - Name contains "frontend"</div>
                <div><code className="bg-blue-100 px-2 py-0.5 rounded">commit:abc</code> - Commit contains "abc"</div>
              </div>
            </div>
            ...
            <div className="mt-3">
              ...
              <div className="ml-4 mt-1">
                <div><code className="bg-blue-100 px-2 py-0.5 rounded">status=success branch:main</code></div>
              </div>
            </div>
            ...
            <div className="mt-3">
              ...
              <div className="ml-4 mt-1 text-xs">
                name, status, branch, commit, lastRun, duration
              </div>
            </div>
          </div>
        </div>
...
export function filterPipelines<T extends Record<string, any>>(items: T[], query: string): T[] {
